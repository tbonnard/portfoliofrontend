...
import python from '../../files/techno/python_.png'
...
import csharp from '../../files/techno/csharp.png'
    ...
    return (
        <div id='techno' className="container">
                ...
                <div className="technoItems">
                    ...
                    <img className="technoItem" src={html_css} alt='HTLM_CSS' title='HTLM CSS' style={{backgroundColor: "#180000"}}/>
